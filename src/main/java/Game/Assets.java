...
public class Assets
{
    ...
    public static final Image MENUGUI = new Image("gui/gui.png", 352, 288, 0);
    public static final Image MENUGUIBUTTON = new Image("gui/guiButton.png", 288, 48, 0);
    public static final Image MENUGUIBUTTONCKICKED = new Image("gui/guiButtonClicked.png", 288, 48, 0);
